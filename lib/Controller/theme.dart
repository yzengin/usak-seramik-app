...
ThemeData appThemeLight() => ThemeData(
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        ...
        elevation: 0,
        selectedIconTheme: IconThemeData(color: AppColors.blackS1),
        unselectedIconTheme: IconThemeData(color: AppColors.greyS5),
        selectedItemColor: AppColors.blackS1,
...
ThemeData appThemeDark() => ThemeData(
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        backgroundColor: AppColors.blackS6,
        elevation: 0,
